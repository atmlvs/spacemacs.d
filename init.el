...
values."
  (setq-default
   ...
   '(
     ...
     semantic
     ;; restclient
     ;; (closure :variables closure-enable-fancify-symbols t)
     ;; ipython-notebook
     ;; osx
     ;; vimscript
     ...
     ranger
     ;; search-engine
     ;; (syntax-checking :vairables syntax-checking-enable-by-default nil)
...
`dotspacemacs/user-config' first."
  ...
  (setq-default
   ...
   open-junk-fil-find-file-function 'find-file
